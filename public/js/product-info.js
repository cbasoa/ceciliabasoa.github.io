...
function callJSONImg() {
    fetch("/api/products_info/" + receivedProd + ".json")
...
async function callJSON() {
    try {
        const response = await fetch("/api/products_info/" + receivedProd + ".json")
...
async function callJSONcomm() {
    try {
        const response = await fetch("/api/products_info_comments/" + receivedProd + ".json")
        const data = await response.json()
        com = data;
